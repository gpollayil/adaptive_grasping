...
namespace adaptive_grasping {
    ...
    private:
        ...
        ros::Subscriber x_d_reference_sub;                    // Subscriber to x_d_reference
        ros::Subscriber f_d_d_reference_sub;                  // Subscriber to f_d_d_reference
        ...
        ros::ServiceClient signal_client;                     // Service client to signal that adaptive grasping ended
        std_srvs::Trigger signal_srv;                         // Service message to be sent to trigger end
        ...
        */
        ...
        /** GETXREFERENCE
        * @brief Callback function to get the x_d from a topic
        *
        * @param msg
        * @return null
        */
        void getXReference(const std_msgs::Float64MultiArray::ConstPtr &msg);

        /** GETFREFERENCE
        * @brief Callback function to get the f_d_d from a topic
        *
        * @param msg
        * @return null
        */
        void getFReference(const std_msgs::Float64MultiArray::ConstPtr &msg);
        ...
        */
        bool
        agCallback(adaptive_grasping::adaptiveGrasp::Request &req, adaptive_grasping::adaptiveGrasp::Response &res);
